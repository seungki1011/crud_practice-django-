...
if (!config.project_container) { error("project_container"); }
...
var MagicGrid = function MagicGrid (config) {
    ...
    if (config.project_container instanceof HTMLElement) {
    this.project_container = config.project_container;
    this.project_containerClass = config.project_container.className;
}
    else {
    this.project_containerClass = config.project_container;
    this.project_container = document.querySelector(config.project_container);
}
...
MagicGrid.prototype.initStyles = function initStyles () {
  ...
  this.project_container.style.position = "relative";
...
MagicGrid.prototype.items = function items () {
  return this.project_container.children;
};
...
MagicGrid.prototype.setup = function setup () {
  var width = this.project_container.getBoundingClientRect().width;
 ...
 * and index then stretches the project_container to
...
MagicGrid.prototype.positionItems = function positionItems () {
  ...
  this.project_container.style.height = maxHeight + this.gutter + "px";
};
...
MagicGrid.prototype.getReady = function getReady () {
  ...
  var interval = setInterval(function () {
    this$1.project_container = document.querySelector(this$1.project_containerClass);
